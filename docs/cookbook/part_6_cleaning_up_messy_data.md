# Cookbook 6: Cleaning Up Messy Data

As in [part 2 of the cookbook](docs/cookbook/part_2_selecting_rows_and_columns.md), we are going to use the 311 service requests data from [NYC Open Data](https://nycopendata.socrata.com/Social-Services/311-Service-Requests-from-2010-to-Present/erm2-nwe9). The data should already be downloaded and ready to load:
